...
//end
	...
	Get_Installment_Details: function (Installment_Type_Id, Course_Id,Student_Course_Id,Student_Id, callback) {
		return db.query(
			"CALL Get_Installment_Details(@Installment_Type_Id :=?,@Course_Id :=?,@Student_Course_Id :=?,@Student_Id :=?)",
			[Installment_Type_Id, Course_Id,Student_Course_Id,Student_Id],
			callback
		);
	},
...
// }
  ...
  return {response};  
	...
	Search_Lead_Report: function (
		...
		return db.query(
			"CALL Search_Lead_Report(@Is_Date_ :=?,@From_Date_ :=?,@To_Date_ :=?,@Enquiry_Source_ :=?,@Login_User_:=?,@User_Id_:=?,@status_:=?,@Course_Id_:=?,@Register_Value_:=?,@Branch_Id_:=?)",
			[
				Is_Date_,
				From_Date_,
				To_Date_,
	...
	Search_Followup_Report: function (
		Is_Date_,
		From_Date_,
		To_Date_,
		Enquiry_Source_,
		...
		return db.query(
			"CALL Search_Followup_Report(@Is_Date_ :=?,@From_Date_ :=?,@To_Date_ :=?,@Enquiry_Source_ :=?,@Login_User_:=?,@User_Id_:=?,@status_:=?,@Course_Id_:=?,@Register_Value_:=?)",
			[
				Is_Date_,
				From_Date_,
				To_Date_,
	...
	Search_Batch_Report: function (
		...
		To_Date_,
		Batch_,
		Faculty_,User_Id_,Branch_Id_,
		callback
	) {
		
		return db.query(
			"CALL Search_Batch_Report(@Is_Date_ :=?,@From_Date_ :=?,@To_Date_ :=?,@Batch_ :=?,@Faculty_ :=?,@User_Id_ :=?,@Branch_Id_ :=?)",
			[
				Is_Date_,
				From_Date_,
				To_Date_,
	...
	Search_Certificate_Report: function (
		Is_Date_,
		From_Date_,
		To_Date_,
		Batch_,
		...
		return db.query(
			"CALL Search_Certificate_Report(@Is_Date_ :=?,@From_Date_ :=?,@To_Date_ :=?,@Batch_ :=?,@Faculty_ :=?,@User_Id_ :=?)",
			[
				Is_Date_,
				From_Date_,
				To_Date_,
...
Search_Agreement_Details: function (Is_Date_, From_Date_, To_Date_, Course_,Batch_Id_,student_name_,Faculty_Id_, callback) {
	return db.query(
		"CALL Search_Agreement_Details(@Is_Date_ :=?,@From_Date_ :=?,@To_Date_ :=?,@Course_ :=?,@Batch_Id_ :=?,@student_name_ :=?,@Faculty_Id_ :=?)",
		[Is_Date_, From_Date_, To_Date_, Course_,Batch_Id_,student_name_,Faculty_Id_],
		callback
	);
},

	Save_Agreement_Details:function(Agreement_Details_Master_Data,callback)
	{ 
	 
	 var Document_value_ = 0; 
	  let Agreement_Details_Master_ = Agreement_Details_Master_Data.Agreement_Details_Master_Data_De;
	  if (Agreement_Details_Master_ != undefined && Agreement_Details_Master_ != '' && Agreement_Details_Master_ != null)
		 Document_value_ = 1;  
		
	return db.query("CALL Save_Agreement_Details("+"@Agreement_Details_Master_:=?)"
	,[Agreement_Details_Master_],callback);
		...
		// console.log(Email_)
			...
			const pool = db.promise();
				...
				"@Description_ :=?"+")"
					...
					Download_Certificate_Data:function(Certificate_,callback)
					{ 
				return db.query("CALL Download_Certificate_Data(@Student_Id_ :=?)"
					,[Certificate_.Student_Id],callback);
					}
					,
...
Search_ExamResult_Final: function (Course_, Batch_, Faculty_, callback) {
	return db.query(
		"CALL Search_ExamResult_Final(@Course_ :=?,@Batch_ :=?,@Faculty_ :=?)",
		[Course_, Batch_, Faculty_],
		callback
	);
},
...
Search_LevelScore_Details_Student: function (Course_, Batch_, Faculty_,Name_, callback) {
	return db.query(
		"CALL Search_LevelScore_Details_Student(@Course_ :=?,@Batch_ :=?,@Faculty_ :=?,@Name_ :=?)",
		[Course_, Batch_, Faculty_,Name_],
		callback
	);
},
...
Search_Examdetails_Final: function (
	...
	return db.query(
		"CALL Search_Examdetails_Final(@Is_Date_ :=?,@From_Date_ :=?,@To_Date_ :=?,@Course_ :=?,@Batch_ :=?,@Faculty_ :=?)",
		[Is_Date_, From_Date_, To_Date_, Course_, Batch_, Faculty_],
		callback
	);
},
...
Search_LevelScore_Master_Student: function (
	Is_Date_,
	From_Date_,
	To_Date_,
	Course_,
	...
	return db.query(
		"CALL Search_LevelScore_Master_Student(@Is_Date_ :=?,@From_Date_ :=?,@To_Date_ :=?,@Course_ :=?,@Batch_ :=?,@Faculty_ :=?)",
		[Is_Date_, From_Date_, To_Date_, Course_, Batch_, Faculty_],
		callback
	);
},
...
Get_ExamresultdetailsFinal: function (
	...
	return db.query(
		"CALL Get_ExamresultdetailsFinal(@Final_Exam_Master_Id_ :=?,@Course_ :=?,@Batch_ :=?,@Faculty_ :=?)",
		[Final_Exam_Master_Id_, Course_, Batch_, Faculty_],
		callback
	);
},


Get_LevelScore_Student_Details: function (
    ...
    return db.query(
        "CALL Get_LevelScore_Student_Details(@Level_Score_Master_Id_ :=?,@Course_ :=?,@Batch_ :=?,@Faculty_ :=?)",
        [Level_Score_Master_Id_, Course_, Batch_, Faculty_],
        callback
    );
},
...
Delete_LevelScore_Student:function(Level_Score_Master_Id,callback)
{ 
return db.query("CALL Delete_LevelScore_Student(@Level_Score_Master_Id :=?)",[Level_Score_Master_Id],callback);
}
,
...
Save_Exam_Creation:function(Exam_Creation_,callback)
{ 
    console.log(Exam_Creation_)
return db.query("CALL Save_Exam_Creation("+"@Exam_Creation_Id_ :=?,"+"@Duration_Type_Id_ :=?,"+"@No_Of_Days_ :=?,"+"@Percentage_ :=?,"+"@User_Id_ :=?"+")"
,[Exam_Creation_.Exam_Creation_Id,Exam_Creation_.Duration_Type_Id,Exam_Creation_.No_Of_Days,Exam_Creation_.Percentage,Exam_Creation_.User_Id ],callback);
},
Delete_Exam_Creation:function(Exam_Creation_Id_,callback)
{ 
return db.query("CALL Delete_Exam_Creation(@Exam_Creation_Id_ :=?)",[Exam_Creation_Id_],callback);
},
Get_Exam_Creation:function(Exam_Creation_Id_,callback)
{ 
return db.query("CALL Get_Exam_Creation(@Exam_Creation_Id_ :=?)",[Exam_Creation_Id_],callback);
},
Search_Exam_Creation:function(Exam_Creation_Name_,callback)
{ 
// if (Exam_Creation_Name_===undefined || Exam_Creation_Name_==="undefined" )
// Exam_Creation_Name_='';
return db.query("CALL Search_Exam_Creation(@Exam_Creation_Name_ :=?)",[Exam_Creation_Name_],callback);
},

Search_Level_Details_Status: function (Is_Date_, From_Date_, To_Date_, Course_,Batch_Id_,student_name_,Faculty_Id_,Login_User_, callback) {
	return db.query(
		"CALL Search_Level_Details_Status(@Is_Date_ :=?,@From_Date_ :=?,@To_Date_ :=?,@Course_ :=?,@Batch_Id_ :=?,@student_name_ :=?,@Faculty_Id_ :=?,@Login_User_ :=?)",
		[Is_Date_, From_Date_, To_Date_, Course_,Batch_Id_,student_name_,Faculty_Id_,Login_User_],
		callback
	);
},


Save_Entry_Level_Details:function(Level_Details_Status_Master_,callback)
{ 
    console.log(Level_Details_Status_Master_)
return db.query("CALL Save_Entry_Level_Details("+"@Entry_Level_ :=?,"+"@Personality_and_Professionalism_Entrylevel_ :=?,"+"@Entry_Level_Add_UserId_ :=?,"+"@Student_Id_ :=?,"+"@Student_Course_Id_ :=?"+")"
,[Level_Details_Status_Master_.Entry_Level,Level_Details_Status_Master_.Personality_and_Professionalism_Entrylevel,Level_Details_Status_Master_.Entry_Level_Add_UserId,Level_Details_Status_Master_.Student_Id,Level_Details_Status_Master_.Student_Course_Id ],callback);
},

Save_Mid_Level_Details:function(Level_Details_Status_Master_,callback)
{ 
    console.log(Level_Details_Status_Master_)
return db.query("CALL Save_Mid_Level_Details("+"@Mid_Level_ :=?,"+"@Personality_and_Professionalism_Midlevel_ :=?,"+"@Mid_Level_Add_UserId_ :=?,"+"@Student_Id_ :=?,"+"@Student_Course_Id_ :=?"+")"
,[Level_Details_Status_Master_.Mid_Level,Level_Details_Status_Master_.Personality_and_Professionalism_Midlevel,Level_Details_Status_Master_.Mid_Level_Add_UserId,Level_Details_Status_Master_.Student_Id,Level_Details_Status_Master_.Student_Course_Id ],callback);
},

Save_Exit_Level_Details:function(Level_Details_Status_Master_,callback)
{ 
    console.log(Level_Details_Status_Master_)
return db.query("CALL Save_Exit_Level_Details("+"@Exit_Level_ :=?,"+"@Personality_and_Professionalism_Exitlevel_ :=?,"+"@Exit_Level_Add_UserId_ :=?,"+"@Student_Id_ :=?,"+"@Student_Course_Id_ :=?"+")"
,[Level_Details_Status_Master_.Exit_Level,Level_Details_Status_Master_.Personality_and_Professionalism_Exitlevel,Level_Details_Status_Master_.Exit_Level_Add_UserId,Level_Details_Status_Master_.Student_Id,Level_Details_Status_Master_.Student_Course_Id ],callback);
},

Save_Project_Details:function(Level_Details_Status_Master_,callback)
{ 
    console.log(Level_Details_Status_Master_)
return db.query("CALL Save_Project_Details("+"@Project_Score_ :=?,"+"@Project_Url_ :=?,"+"@Project_Add_UserId_ :=?,"+"@Student_Id_ :=?,"+"@Student_Course_Id_ :=?"+")"
,[Level_Details_Status_Master_.Project_Score,Level_Details_Status_Master_.Project_Url,Level_Details_Status_Master_.Project_Add_UserId,Level_Details_Status_Master_.Student_Id,Level_Details_Status_Master_.Student_Course_Id ],callback);
},

Search_Score_Card_Report: function (Is_Date_, From_Date_, To_Date_, Course_,Batch_Id_,student_name_,Faculty_Id_, callback) {
	return db.query(
		"CALL Search_Score_Card_Report(@Is_Date_ :=?,@From_Date_ :=?,@To_Date_ :=?,@Course_ :=?,@Batch_Id_ :=?,@student_name_ :=?,@Faculty_Id_ :=?)",
		[Is_Date_, From_Date_, To_Date_, Course_,Batch_Id_,student_name_,Faculty_Id_],
		callback
	);
},

Search_Batch_Attendance: function (
	From_Date,
	To_Date,
	Faculty_Id,
	Course_,
	...
	// console.log(User_Id_);
	return db.query(
		"CALL Search_Batch_Attendance(@From_Date :=?,@To_Date :=?,@Faculty_Id :=?,@Course_ :=?,@Batch_ :=?,@Attendance_Status_Id :=?,@User_Id_ :=?,@Is_Date_ :=?,@Branch_Id_ :=?)",
		[
			From_Date,
			To_Date,
			Faculty_Id,
...
Load_Batch_Attendance_Details: function (
	Student_Id_,
	Batch_Id_,
	Course_Id_,
	Attendance_Status_,
	...
	return db.query(
		"CALL Load_Batch_Attendance_Details(@Student_Id_ :=?,@Batch_Id_ :=?,@Course_Id_ :=?,@Attendance_Status_ :=?)",
		[
			Student_Id_,
			Batch_Id_,
			Course_Id_,
...
Update_Batch_Completion_Status: function (login_user_, callback) {
	console.log(login_user_);
	return db.query(
		"CALL Update_Batch_Completion_Status(@login_user_ :=?)",
		[login_user_,],
		callback
	);
},
...
Save_Level_Score_Student: async function (Level_Score_Master_) {
    console.log(Level_Score_Master_);
    return new Promise(async (resolve, reject) => {
        ...
        try {
            result1 = await new storedProcedure(
                "Save_Level_Score_Student",
                [
                    Level_Score_Master_.Level_Score_Master_Id,
                    Level_Score_Master_.Course_Id,
                    Level_Score_Master_.User_Id,
                    Level_Score_Master_.Batch_Id,
                    Level_Score_Master_.Level_Score_Details,
                    Level_Score_Master_.Level_Score_Details_Value,
                ],
                connection
            ).result();
